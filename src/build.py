...
# sister company, its own site; /bonapp/ here is kept as redirect stubs to it
BONAPP = "https://bon-app.net"
...
<li><a href="{BONAPP}" rel="noopener">Also from us: Bon App &amp; T</a></li>
</ul>
</div>
<div class="footer__col">
<h4>Support</h4>
